                                ...
                                <?php
                                    ...
                                    <div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown" style="width: 310px">
                                       <?php if($res['apply_rc_id']=='apply'){ ?>
                                        ...
                                        <a class="dropdown-item nav-link" href="feedback.php?User_id=<?php echo"$user_id";?>">Feedback</a>
                                        ...
                                        <a class="dropdown-item nav-link" href="feeedback.php?User_id=<?php echo"$user_id";?>">Feedback</a>
