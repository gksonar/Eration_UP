    ...
    <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Schemes</a></li>
                    </ol>
                </div>
            </div>
...
echo " alert('Schemes Already Exists');";
