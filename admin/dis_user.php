            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Not Verified User</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
<?php
 $count = 1;
$asd=mysqli_query($con,"select * from user_ration_form_details where user_status='Not Verifie'") or die(mysqli_error($con));
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="input-group input-group-sm" style="width: 20%;margin-left: 73%">
                                ...
                                <h4 class="card-title">Nor Verified User</h4>
