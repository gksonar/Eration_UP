...
<div class="card">
<div class="card-body">
<h4 class="card-title">Ration Card Details</h4>
...
<div id="collapseOne4" class="collapse show" data-parent="#accordion-three">
    ...
    <p><b>Local Address:</b><a style="margin-left: 10.5%"><?php echo $user_addreess1;?></a></p>
...
<div class="card">
<div class="card-header">
    <h5 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapseTwo5" aria-expanded="false" aria-controls="collapseTwo5"><i class="fa" aria-hidden="true"></i> Bank Account Details, Ration Card Type & Gas Connection Details</h5>
</div>
...
<div id="collapseThree6" class="collapse" data-parent="#accordion-three">
    <div class="card-body">
        ...
        <!-- <a><b>Family Photo:&nbsp;&nbsp;</b><img src="../images/<?php //echo $fetch['user_family_photo']?>" height="100" width="100" /></a> --><br><br><br><br>
           ...
           <h6>Address Proof:</h6>
           <a href="../address proof/<?php echo $fetch['user_family_photo']?>" style="margin-bottom:'5px';" view><?php echo $fetch['user_family_photo']?></a>
...
<div>
    <center><a href="allocate_schedule.php?User_id=<?php echo "$user_id";?>"><button class="btn btn-info">Allocate Schedule</button></a></center>
</div>
</div>
<!-- #/ container -->
