            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Disapproved User</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
<?php
 $count = 1;
$asd=mysqli_query($con,"select * from user_ration_form_details where user_status='Disapproved'") or die(mysqli_error($con));
                                        ...
                                        <?php while($fetch=mysqli_fetch_array($asd))
                              {
                                        ...
                                        <tbody id="myTable">
                                            <tr>
                                                ...
                                                <td><a href="userapproved.php?User_id=<?php echo "$user_id";?>"><i class="fa fa-thumbs-up" aria-hidden="true"></i></a></td>
