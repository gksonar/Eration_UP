...
<div class="content-body">
    <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Ration Provider</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Ration Request</a></li>
                    </ol>
                </div>
            </div>
...
<div class="row">
 <div class="col-lg-3"></div>
   <div class="col-lg-6">
    <div class="card">
        <div class="card-body">
            <h3 align="center">list of Ration Details</h3><br>
