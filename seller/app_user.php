...
<?php
 $count = 1;
$asd=mysqli_query($con,"select * from user_ration_form_details where user_status='Approved'") or die(mysqli_error($con));
                                        ...
                                        <?php while($fetch=mysqli_fetch_array($asd))
                              {
                                        ...
                                        <tbody id="myTable">
                                            <tr>
                                                ...
                                                <td><a href="userdisapproved.php?User_id=<?php echo "$user_id";?>"><i class="fa fa-thumbs-down" aria-hidden="true"></i></a></td>
